...
if __name__ == "__main__":
    ...
    DB.insert("dialogue","(3,\"The cat blinks, then opens its mouth: \n  And who might you be? \", 1, \"The Cat\", \"data/npc_profiles/backgrounds/wall.png\", 1, \"[{\"\"prereq\"\" : [], \"\"set\"\" : [], \"\"goto\"\" : -1, \"\"body\"\" : \"\"A friend.\"\"},{\"\"prereq\"\" : [], \"\"set\"\" : [], \"\"goto\"\" : -1, \"\"body\"\" : \"\"A travler.\"\"},{\"\"prereq\"\" : [], \"\"set\"\" : [], \"\"goto\"\" : -1, \"\"body\"\" : \"\"Nobody.\"\"},{\"\"prereq\"\" : [], \"\"set\"\" : [], \"\"goto\"\" : -1, \"\"body\"\" : \"\"It talk’s!\"\"},{\"\"prereq\"\" : [], \"\"set\"\" : [], \"\"goto\"\" : -1, \"\"body\"\" : \"\"* refuse to speak *\"\"}]\")")
      #print(DB.get_tables())
