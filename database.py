...
if __name__ == "__main__":
    ...
    DB.insert("dialogue","(4,\"You feel your  light fades back into the sea of white.\", 0, \"Eternity\", \"data/npc_profiles/backgrounds/empty.png\", 1, \"[{\"\"prereq\"\" : [], \"\"set\"\" : [], \"\"goto\"\" : -1, \"\"body\"\" : \"\"* Let go *\"\"},{\"\"prereq\"\" : [], \"\"set\"\" : [], \"\"goto\"\" : 0, \"\"body\"\" : \"\"* Blink *\"\"}]\")")
